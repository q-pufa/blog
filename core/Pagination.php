...
class Pagination
{
    ...
    {
        return (int)ceil($this->total / $this->per_pag) ?: 1;
    }
    ...
    {
        return ($this->current_page - 1) * $this->per_pag;
    }
    ...
    public function getHtml(): string
    {
        ...
        return '<nav aria-label="Page navigation example"><ul class="pagination">' . $start_page . $back . $pages_left . '<li class="page-item "><a class="page-link active">' . $this->current_page . '</a></li>' . $pages_right . $forward . $end_page . '</ul></nav>';
    }
